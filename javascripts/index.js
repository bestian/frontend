...
(function(){
  var chainCtrl, toIndex, myHash, myDummy;
  chainCtrl = function($scope, $sce, $title, $path, $dummy, $hash){
  ...
  angular.module('chainApp', []).constant('$path', 'https://ethercalc.org/').constant('$title', 'bt_frontend').constant('$dummy', myDummy).factory('$hash', myHash).filter('toIndex', toIndex).controller('chainCtrl', chainCtrl);
}).call(this);
